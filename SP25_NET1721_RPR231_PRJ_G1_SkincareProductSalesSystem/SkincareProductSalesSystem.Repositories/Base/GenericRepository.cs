...
namespace SkincareProductSalesSystem.Repositories.Base
{
    ...
    {
        protected SP25_NET1721_RPR231_PRJ_G1_SkincareProductSalesSystemDBContext _context;

        public GenericRepository()
        {
            _context ??= new SP25_NET1721_RPR231_PRJ_G1_SkincareProductSalesSystemDBContext();
        }

        #region Separating asign entity and save operators

        public GenericRepository(SP25_NET1721_RPR231_PRJ_G1_SkincareProductSalesSystemDBContext context)
        {
            _context = context;
        }
